...
class TestOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--cone_path', type=str, help='path to folder with cones)')
        self.parser.add_argument('--label_path', type=str, help='path to folder with labels')
        self.parser.add_argument('--save_path', type=str, help='path to save labeled dataset')
        self.isTrain = False
